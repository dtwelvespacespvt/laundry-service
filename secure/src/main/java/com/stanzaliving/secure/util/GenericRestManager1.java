...
@Log4j2
@Service
public class GenericRestManager1 {
    ...
    protected <T> T get(String baseUrl, String url, Map<String, Object> queryParams, Map<String, String> overrideHeaders, boolean skipDefaultHeaders, Type responseClassType) throws CustomRuntimeException, UnauthorisedException, HttpClientErrorException, HttpServerErrorException {
        HttpMethod method = HttpMethod.GET;
        String fullUrl = getFinalUrl(baseUrl, url, queryParams);
    ...
    public <T> T post(String baseUrl, String url, Map<String, Object> queryParams, Object body, Map<String, String> overrideHeaders, boolean skipDefaultHeaders, Type responseClassType) {
    ...
    public <T> T put(String baseUrl, String url, Map<String, Object> queryParams, Object body, Map<String, String> overrideHeaders, boolean skipDefaultHeaders, Type responseClassType) {
    ...
    protected <T> T _execute(String fullUrl, HttpMethod method, HttpHeaders headers, Object body, ParameterizedTypeReference<T> parameterizedTypeReference, HttpEntity<?> httpEntity, ResponseEntity<T> responseEntity) {
        try {
            logBeforeCall(fullUrl, method, headers, body.toString());
    ...
    protected <T> T handleHttpStatusCodeException(String fullUrl, HttpMethod method, HttpHeaders headers, Object body, HttpStatusCodeException ex) throws CustomRuntimeException, UnauthorisedException {
        ...
        if (ex.getStatusCode() == HttpStatus.GATEWAY_TIMEOUT) {
            ...
            throw new CustomRuntimeException(String.format("System error [GATEWAY_TIMEOUT]. Please contact tr tech with error as something went wrong please check with this code : "), ex.getStatusCode());
        }

        if (ex.getStatusCode() == HttpStatus.UNAUTHORIZED) {
            log.info("Unauthorized Exception with message :" + ex.getMessage());
            throw new UnauthorisedException(String.format("Service: System error : "));
        }

        else {
            log.warn("ErrorResponse model change required");
            log.info("Error with message :" + ex.getMessage());
            throw new CustomRuntimeException("System error" + ex.getMessage() + ex.getResponseBodyAsString(), ex.getStatusCode());
        }
    }
    ...
    protected <T> T handleRestClientException(String fullUrl, HttpMethod method, HttpHeaders headers, Object body, RestClientException ex) throws CustomRuntimeException {
        ...
        throw new CustomRuntimeException(String.format("System error %s ", ex.getMessage()), HttpStatus.INTERNAL_SERVER_ERROR);
    }
    ...
    protected <T> T handleResourceAccessException(String fullUrl, HttpMethod method, HttpHeaders headers, Object body, ResourceAccessException ex) throws HttpClientErrorException, HttpServerErrorException {
        if (ex.getCause() instanceof SocketTimeoutException || ex.getCause() instanceof ConnectException) {
            ...
            throw new HttpClientErrorException(HttpStatus.REQUEST_TIMEOUT, String.format("I/O error on get request %s %s", ex.toString(), HttpStatus.REQUEST_TIMEOUT));
        } else {
            throw new HttpServerErrorException(HttpStatus.INTERNAL_SERVER_ERROR, String.format("I/O error on get request %s %s", ex.toString(), HttpStatus.INTERNAL_SERVER_ERROR));
        }
    }
    ...
    protected void logBeforeCall(String fullUrl, HttpMethod method, HttpHeaders headers, Object body) {
        log.info(toJson(new HashMap<String, Object>() {{
            put("message", String.format("called"));
    ...
    public <T> T delete(String baseUrl, String url, Map<String, Object> queryParams, Object body, Map<String, String> overrideHeaders, boolean skipDefaultHeaders, Type responseClassType) {
    ...
    public <T> T genericRestCall(String baseUrl, String url, Map<String, Object> queryParams, Map<String, String> overrideHeaders, boolean skipDefaultHeaders, Type responseClassType, Object body, HttpMethod httpMethod) {
        switch(httpMethod) {
            case POST:
                return post(baseUrl, url, queryParams, body, overrideHeaders, skipDefaultHeaders, responseClassType);

            case GET:
                return get(baseUrl, url, queryParams, overrideHeaders, skipDefaultHeaders, responseClassType);

            case PUT:
                return put(baseUrl, url, queryParams, body, overrideHeaders, skipDefaultHeaders, responseClassType);

            case DELETE:
                return delete(baseUrl, url, queryParams, body, overrideHeaders, skipDefaultHeaders, responseClassType);
